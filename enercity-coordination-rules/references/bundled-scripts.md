...
Some EnerCity Collaborative skills ship executable scripts that an agent invokes
during its procedure — the `enercity-emails` skill's
`send-approval.mjs` (the LinkedIn review email).
